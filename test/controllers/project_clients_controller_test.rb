...
class ProjectClientsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create project_client" do
    assert_difference("ProjectClient.count") do
      post project_clients_url, params: { project_client: { address: @project_client.address, contact_no: @project_client.contact_no, contact_support: @project_client.contact_support, name: @project_client.name } }
    end
  ...
  test "should update project_client" do
    patch project_client_url(@project_client), params: { project_client: { address: @project_client.address, contact_no: @project_client.contact_no, contact_support: @project_client.contact_support, name: @project_client.name } }
